...
LESSONS = [
    {"id": "lesson01-intro",      "zip": "act-courseware-ch1-绪论-v2.16.zip",
     "title": "第一章 绪论",
     "desc": "先导概述、开环/闭环/复合控制、系统组成与分类、基本要求（稳·快·准）、课程地图；含 2 页课堂互动题。2026-09-13 起含全局主题更新（结论条贴近页脚不再遮挡内容、小视口舞台居中不裁底），章节内容未变。"},
    {"id": "lesson02-math-model", "zip": "act-courseware-ch2-数学模型-v2.16.zip",
     "title": "第二章 控制系统的数学模型",
     "desc": "微分方程、拉氏变换、传递函数、方框图等效化简、信号流图、梅逊公式；含方框图化简、方框图↔信号流图转换、梅逊公式数回路三个重点交互动画页，另有 4 页课堂互动题。历史修复：信号流图支路箭头统一画在传输线中点（P40-P47）；2026-09-13 起含全局主题更新，章节内容未变。"},
    {"id": "lesson03-timedomain", "zip": "act-courseware-ch3-时域分析-v2.16.zip",
     "title": "第三章 时域分析法",
     "desc": "典型输入与性能指标、一阶/二阶系统响应、劳斯判据与稳定性、稳态误差；含二阶系统参数-特征根-响应曲线联动等重点交互动画。历史修复：SVG 图内文字统一 STIX2 公式字体、标注避线与字号放大、箭头方向修正、mk() parent 缺陷修复（Astra 修复版融入）；2026-09-13 起含全局主题更新，章节内容未变。"},
    {"id": "lesson04-freq",       "zip": "act-courseware-ch4-频率响应-v2.16.zip",
     "title": "第四章 频率响应法",
