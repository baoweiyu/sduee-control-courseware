...
LESSONS = [
    {"id": "lesson01-intro",      "zip": "act-courseware-ch1-绪论-v2.17.zip",
     "title": "第一章 绪论",
     "desc": "先导概述、开环/闭环/复合控制、系统组成与分类、基本要求（稳·快·准）、课程地图；含 2 页课堂互动题。2026-09-13 起含全局主题更新（结论条贴近页脚不再遮挡内容、小视口舞台居中不裁底），章节内容未变。"},
    {"id": "lesson02-math-model", "zip": "act-courseware-ch2-数学模型-v2.17.zip",
     "title": "第二章 控制系统的数学模型",
    ...
    {"id": "lesson03-timedomain", "zip": "act-courseware-ch3-时域分析-v2.17.zip",
     "title": "第三章 时域分析法",
    ...
    {"id": "lesson04-freq",       "zip": "act-courseware-ch4-频率响应-v2.17.zip",
     "title": "第四章 频率响应法",
