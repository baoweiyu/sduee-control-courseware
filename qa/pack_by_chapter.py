...
LESSONS = [
    {"id": "lesson01-intro",      "zip": "act-courseware-ch1-绪论-v2.19.zip",
     "title": "第一章 绪论",
     "desc": "先导概述、开环/闭环/复合控制、系统组成与分类、基本要求（稳·快·准）、课程地图；含 2 页课堂互动题。2026-09-13 起含全局主题更新（结论条贴近页脚不再遮挡内容、小视口舞台居中不裁底），章节内容未变；2026-09-20 起随第五章四轮细调版发布统一版本号 V2.19。"},
    {"id": "lesson02-math-model", "zip": "act-courseware-ch2-数学模型-v2.19.zip",
     "title": "第二章 控制系统的数学模型",
     "desc": "微分方程、拉氏变换、传递函数、方框图等效化简、信号流图、梅逊公式；含方框图化简、方框图↔信号流图转换、梅逊公式数回路三个重点交互动画页，另有 4 页课堂互动题。历史修复：信号流图支路箭头统一画在传输线中点（P40-P47）；2026-09-13 起含全局主题更新，章节内容未变；2026-09-20 起随第五章四轮细调版发布统一版本号 V2.19。"},
    {"id": "lesson03-timedomain", "zip": "act-courseware-ch3-时域分析-v2.19.zip",
     "title": "第三章 时域分析法",
     "desc": "典型输入与性能指标、一阶/二阶系统响应、劳斯判据与稳定性、稳态误差；含二阶系统参数-特征根-响应曲线联动等重点交互动画。V2.17（2026-09-14）：P6 抛物线按解析式精确绘制、特征点落在线上、图内公式改 MathJax；P14 稳态误差定义换行修复、指标徽章补峰值时间 tp；P25 求根公式补 ζ≥1 适用条件；P27-30 四种阻尼响应页左上卡统一为 C(s)→极点→h(t)→备注顺序并补全 C(s) 表达式。历史修复：SVG 图内文字统一 STIX2 公式字体、标注避线与字号放大、箭头方向修正、mk() parent 缺陷修复（Astra 修复版融入）；2026-09-13 起含全局主题更新。"},
    {"id": "lesson04-freq",       "zip": "act-courseware-ch4-频率响应-v2.19.zip",
     "title": "第四章 频率响应法",
    ...
    {"id": "lesson05-root-locus", "zip": "act-courseware-ch5-根轨迹法-v2.19.zip",
     "title": "第五章 根轨迹法",
     "desc": "根轨迹基本概念、绘制规则七条、广义根轨迹（参数根轨迹/零度根轨迹）、根轨迹分析方法（条件稳定、主导极点、偶极子、零点影响）；61 页，全部根轨迹由数值计算严谨绘制，含连贯生长动画 + 分步演示 + 图面缩放，以及 3 页课堂互动题。V2.19（2026-09-20）：四轮细调版——13 页精修、四个部分封面补全主题配图。"},
]
