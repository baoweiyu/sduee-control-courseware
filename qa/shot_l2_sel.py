# 按页码选择重截第二章页面: python qa/shot_l2_sel.py 23 28 38 ...
import os, sys, subprocess, concurrent.futures

ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
CHROME = r"C:\Program Files\Google\Chrome\Application\chrome.exe"
PAGES_DIR = os.path.join(ROOT, "lessons", "lesson02-math-model", "pages")
OUT_PDF = os.path.join(ROOT, "qa", "ch2-qa", "pdf")
OUT_PNG = os.path.join(ROOT, "qa", "ch2-qa", "png")
...
def shot(fn):
    ...
    url = f"http://localhost:7100/qa/shot.html?page=/lessons/lesson02-math-model/pages/{fn}"
